...
class updateStudent
{
    ...
    public function __construct($id, $fName, $lName, $dateOfBirth, $gender, $address, $city, $postalCode, $country, $platform, $applications, $profile, $nat_id , $spr_id , $field_id)
    {
        $this->id = $id;
        $this->fName = $fName;
        $this->lName = $lName;
    ...
    public function add()
    {
        ...
        //update values 
        $sql = "UPDATE students SET fName = '$fName', lName = '$lName', dateOfBirth = '$dateOfBirth', gender = '$gender', address = '$address', city = '$city', postalCode = '$postalCode', country = '$country', platform = '$platform', applications = '$applications', profile = '$profile' , nat_id = '$nat_id' , spr_id = '$spr_id' , field_id = '$field_id' WHERE ID = '$id'";
