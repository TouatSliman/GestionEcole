...
<body>
    ...
    <form action="./creatBulletin" method="post">
        <div class="">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row2["codeModule"] . "</td>";
                    echo "<td>" . $row2["designation"] . "</td>";
                    echo "<td class='coff'>" . $row2["coff"] . "</td>";
        ...
        */
            ...
            ?>
            <p>la somme des coefficient est : <span id="sommeCoeff"></span> </p>
            <p>la somme des notes est : <span id="somme"></span></p>
            <p>la moyenne est : <span id="moyenne"></span> </p>
